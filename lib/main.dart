...
// ================================================
// SpinWheelPicker, spin_wheel_picker 치환 후 사용
// mbti_pro 프로덕션 패턴 기반
...
import 'package:spin_wheel_picker/app/admob/ads_interstitial.dart';
...
Future<void> main() async {
  ...
  runApp(const SpinWheelPickerApp());
}

class SpinWheelPickerApp extends StatelessWidget {
  const SpinWheelPickerApp({super.key});
